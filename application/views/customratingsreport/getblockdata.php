...
<h4 style="margin:15px 8px 10px;">Block level performance</h4>
<div class="chartBoxPanel">
           <div class="chartBoxOuter lbg block_click" style="min-width: 40%;width:100%;">
             ...
             echo $request['kpa_id'].$level1." : ".$request['zone_name']."'s Performance";?></h4>
               ...
               <div class="chartBox" style="width:<?php echo (count($data)*60+50)."px";?>">                  
                       ...
                       ?>
                   <a href="#data_school"><div class="lineBar cb" style="height:211px;width:40px;margin:0 20px;" onclick="clusterReport('<?php echo $request['type'];?>',<?php echo $request['kpa_id'];?>,'<?php echo $key;?>')">
