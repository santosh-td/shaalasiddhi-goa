...
<div class="">
    ...
    <div class="subTabWorkspace pad26">
        <div class="form-stmnt">
            <form enctype="multipart/form-data" method="post" id="create_cluster_data_form" action="#" name="clusterreport">
                ...
                <dl id="provinces"  class="fldList">
                    ...
                    <dd>
                        <div class="row">
                            <div class="col-sm-6 width-50-modal">
                                <select class="form-control province-list-dropdown" name="province[]" id="rec_province"  required="required">
                ...
                <dl id="rec_report_name" class="fldList">
                    <dt>Without School</dt>
                    <dd>
                        <div class="row">
                            <div class="col-sm-6 width-50-modal" style="">
                                <input type="checkbox" name="un_review" class="user-roles" id="un_review" value="1">
                            </div>
                        </div>
                    </dd>
                </dl>
                    ...
                    <dd>
                        <div class="row">
                            <div class="col-sm-6 width-50-modal">
                                ...
                                <input type="submit" id="clusterreport" name="submitevidencedata" value="Generate Report" class="btn btn-primary mt25 mb30">
                            </div>
                        </div>
                    </dd>
                </dl>
